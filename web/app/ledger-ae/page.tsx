  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-navy-deep text-white">
        ...
        <div className="wrap section grid gap-12 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="reveal font-mono text-[13px] font-bold uppercase tracking-[0.24em] text-gold">
              Built by the Ledger.ae team
            </p>
            <h2 className="reveal mt-5 max-w-[20ch] font-display text-[clamp(28px,4vw,44px)] font-semibold leading-[1.08] tracking-[-0.04em] text-balance">
              Meet LedgerLens UAE
            </h2>
            <p className="reveal mt-5 max-w-[60ch] text-[15px] leading-[1.8] text-white/65">
              A secure, evidence-backed document workspace for accounting firms — search client
              files in seconds, ask a question and get a cited answer, and know exactly what&rsquo;s
              missing before a VAT review starts.
            </p>
          </div>
          <div className="reveal">
            <Link href="/ledgerlens" className="btn btn-gold whitespace-nowrap">
              Explore LedgerLens &rarr;
            </Link>
          </div>
        </div>
      </section>
